...
/**
* View class for displaying the home page of the application
*/
class LandingView extends View {
	...
	* @param array $array (contains an array of arrays of sublists, notes, and navigation items needed for the home view)
	*/
	...
	/**
	* Renders the home page on the web browser with the following properties:
	* 	1. Header
	*   2. Navigation
	*	3. Sublists
	*	4. Notes
